...
# r1 = requests.post("http://127.0.0.1:8081/init_funtion_template/completions", data=post_json)
...
# r1 = requests.post("http://127.0.0.1:8081/chat/completions", data=post_json)
# print(r1.content.decode("utf8"))
...
# r1 = requests.post("http://127.0.0.1:8081/chat_funtion_intention/completions", data=post_json)
# print(r1.content.decode("utf8"))

# ##
# post_json=json.dumps({"funtion_id":"888","message":[{"role": "user", "content": "我想查询订单456的详情"}]})
# r1 = requests.post("http://127.0.0.1:8081/chat_funtion/completions", data=post_json)
# print(r1.content.decode("utf8"))
...
post_json=json.dumps({"funtion_id":"888","message":[{"role": "user", "content": "我想查询订单45689654的详情"},{"role": "assistant", "content": "请明确告诉我要查询的日期是"},
                                                    {"role": "user", "content": "一周前"}]})
