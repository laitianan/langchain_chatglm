...
def _get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/data/laitianan/Langchain-Chatchat-master/text2vec-large-chinese",
        help="Checkpoint name or path, default to embeddings",
    )
    ...
    parser.add_argument(
        "--server-port", type=int, default=8081, help="Demo server port."
    )
    parser.add_argument(
        "--server-name",
        type=str,
...
if __name__ == "__main__":
    ...
    # t2v_model = SentenceModel(args.embeddings_checkpoint_path)
