...
你的回答:
    ...
    def testinterface4(self):
        ...
        cont="""单号：xs1234565，商品名称：黑森林，单价：158，数量：1，用户购买量：三千万，总价：158，配送时间：2023-11-18配送状态：结束"""
        cont2="""{数量：300}"""
        post_json=json.dumps({
            "funname_resp":[{"funtion_id": "2114", "resp": cont},
                            {"funtion_id": "2123", "resp": cont2}],
            "message":[
                   {"role": "user", "content":"查询订单xs1234565详情和幸福西饼在多少个城市开店"},
